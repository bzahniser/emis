...
class LevelExamController extends Controller
{
	...
	public function accessRules()
	{
		return array(
			array('allow', // allow authenticated user to perform 'create' and 'update' actions
				'actions'=>array('create','fillCourse','fillLevel','fillSubject'),
				'roles'=>array('LevelExamCreate'),
			),
                        array('allow', // allow authenticated user to perform 'create' and 'update' actions
				'actions'=>array('update','Activate','InActivate'),
				'roles'=>array('LevelExamUpdate'),
			),
                        array('allow',  // allow all users to perform 'index' and 'view' actions
				'actions'=>array('index','admin'),
				'roles'=>array('LevelExamRead'),
			),
                        array('allow', // allow authenticated user to perform 'create' and 'update' actions
				'actions'=>array('delete'),
				'roles'=>array('LevelExamDelete'),
			),
			array('allow', // allow admin user to perform 'admin' and 'delete' actions
				'actions'=>array('view'),
				'roles'=>array('LevelExamView'),
			),
	...
	public function actionActivate($id)
	{
        ...
        public function actionfillCourse() {
            $Parent = $_POST['LevelExam']['ProgramID'];
        ...
        public function actionfillLevel() {
            $Parent = $_POST['LevelExam']['CourseID'];
        ...
        public function actionfillSubject() {
            $LevelID = $_POST['LevelExam']['LevelID'];
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['LevelExam']))
		{
			$model->attributes=$_POST['LevelExam'];
	...
	{
		$dataProvider=new CActiveDataProvider('LevelExam');
	...
	{
		$model=new LevelExam('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['LevelExam']))
			$model->attributes=$_GET['LevelExam'];
	 ...
	 * @return LevelExam the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=LevelExam::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param LevelExam $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='level-exam-form')
		{
