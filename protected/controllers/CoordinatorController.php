	...
	public function accessRules()
	{
		return array(
			array('allow', // allow authenticated user to perform 'create' and 'update' actions
				...
				'roles'=>array('CoordinatorCreate'),
			),
                        array('allow', // allow authenticated user to perform 'create' and 'update' actions
				'actions'=>array('update','Activate','InActivate'),
				'roles'=>array('CoordinatorUpdate'),
			),
                        array('allow',  // allow all users to perform 'index' and 'view' actions
				'actions'=>array('index','admin'),
				'roles'=>array('CoordinatorRead'),
			),
                        array('allow', // allow authenticated user to perform 'create' and 'update' actions
				'actions'=>array('delete'),
				'roles'=>array('CoordinatorDelete'),
			),
			array('allow', // allow admin user to perform 'admin' and 'delete' actions
				'actions'=>array('view'),
				'roles'=>array('CoordinatorView'),
			),
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Coordinator']))
		{
			$model->attributes=$_POST['Coordinator'];
                        ...
                        $model->Active=1;
                        $model->CoordinatorFullName=$model->CoordinatorName.' '.$model->CoordinatorLastName;
