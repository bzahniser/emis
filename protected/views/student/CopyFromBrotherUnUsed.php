...
<div class="panel-group" id="accordion">
    ...
    <div id="collapseOne" class="panel-collapse collapse">
      <div class="panel-body">
                    ...
                    <div class="row">
                            ...
                            <?php echo $form->checkBox($model,'IsMale'); ?>
  ...
  <div class="panel panel-default">
    ...
    <div id="collapseTwo" class="panel-collapse collapse">
      <div class="panel-body">
                            <?php echo $form->hiddenField($modelF,'DID'); ?>
                    <div class="row">
                            <?php echo $form->labelEx($model,'FatherIsAlive'); ?>
                            <?php echo $form->checkBox($model,'FatherIsAlive',array('readonly'=>true)); ?>
                            <?php echo $form->error($model,'FatherIsAlive'); ?>
                    </div>

                    <div class="row">
                            <?php echo $form->labelEx($model,'MotherIsAlive'); ?>
                            <?php echo $form->checkBox($model,'MotherIsAlive',array('readonly'=>true)); ?>
                    ...
                    <div class="row">
                            ...
                            <?php echo $form->textField($modelF,'DocumentID',array('readonly'=>true)); ?>
                            <?php echo $form->error($modelF,'DocumentID'); ?>
                    </div>

                    <div class="row">
                            <?php  echo $form->labelEx($modelF,'FirstName'); ?>
                            <?php  echo $form->textField($modelF,'FirstName',array('readonly'=>true)); ?>
                            <?php  echo $form->error($modelF,'FirstName'); ?>
                    </div>

                    <div class="row">
                            <?php  echo $form->labelEx($modelF,'LastName'); ?>
                            <?php  echo $form->textField($modelF,'LastName',array('readonly'=>true)); ?>
                            <?php  echo $form->error($modelF,'LastName'); ?>
                    </div>

                    <div class="row">
                            <?php  echo $form->labelEx($modelF,'ArabicFirstName'); ?>
                            <?php  echo $form->textField($modelF,'ArabicFirstName',array('readonly'=>true)); ?>
                            <?php  echo $form->error($modelF,'ArabicFirstName'); ?>
                    </div>

                    <div class="row">
                            <?php  echo $form->labelEx($modelF,'ArabicLastName'); ?>
                            <?php  echo $form->textField($modelF,'ArabicLastName',array('readonly'=>true)); ?>
                            <?php  echo $form->error($modelF,'ArabicLastName'); ?>
                    </div>
          
                    <div class="row">
                            <?php  echo $form->labelEx($modelF,'Phone'); ?>
                            <?php  echo $form->textField($modelF,'Phone',array('readonly'=>true)); ?>
                            <?php  echo $form->error($modelF,'Phone'); ?>
                    </div>
                    
                    <div class="row">
                            <?php echo $form->labelEx($model,'NumberOfPersons'); ?>
                            <?php echo $form->textField($model,'NumberOfPersons',array('readonly'=>true)); ?>
