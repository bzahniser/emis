...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		...
		<?php
                    echo $form->dropDownList($model,'ExamID',CHtml::listData(Exam::model()->findAll('Active=1'), 'ExamID', 'ExamName'),
                            array('prompt'=>'-- Select --'));
                ?>
	...
	<div class="row">
		<?php echo $form->labelEx($model,'PassingPercentage'); ?>
		<?php echo $form->textField($model,'PassingPercentage',array('size'=>10,'maxlength'=>10)); ?>
		<?php echo $form->error($model,'PassingPercentage'); ?>
	</div>
