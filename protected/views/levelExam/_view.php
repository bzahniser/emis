...
<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('PassingPercentage')); ?>:</b>
	<?php echo CHtml::encode($data->PassingPercentage); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('PassingRequired')); ?>:</b>
	<?php echo CHtml::encode($data->PassingRequired); ?>
	<br />
