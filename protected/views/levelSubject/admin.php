...
$('.search-form form').submit(function(){
	$('#level-subject-grid').yiiGridView('update', {
		data: $(this).serialize()
	});
	return false;
});
			...
			'class'=>'CButtonColumn',
                        ...
                        (
                            ...
                            (
                                ...
                                'url'=>'Yii::app()->createUrl("levelsubject/Activate", array("id"=>$data->ID))',
                            ...
                            (
                                ...
                                'url'=>'Yii::app()->createUrl("levelsubject/detailView", array("id"=>$data->ID))',
