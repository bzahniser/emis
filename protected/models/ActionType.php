...
/**
 * This is the model class for table "tbl_action_type".
 *
 * The followings are the available columns in table 'tbl_action_type':
...
class ActionType extends CActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
			...
			'logs' => array(self::HAS_MANY, 'Log', 'TypeID'),
		);
	}
