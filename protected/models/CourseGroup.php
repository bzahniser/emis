...
/**
 * This is the model class for table "tbl_course_group".
 *
 * The followings are the available columns in table 'tbl_course_group':
 ...
 */
class CourseGroup extends CActiveRecord
{
	/**
	...
	public function relations()
	{
		...
		return array(
			'courses' => array(self::HAS_MANY, 'Course', 'CourseGroupID'),
