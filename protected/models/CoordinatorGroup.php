...
/**
 * This is the model class for table "tbl_coordinator_group".
 *
 * The followings are the available columns in table 'tbl_coordinator_group':
 ...
 */
class CoordinatorGroup extends CActiveRecord
{
	/**
	...
	public function relations()
	{
		...
		return array(
			'coordinators' => array(self::HAS_MANY, 'Coordinator', 'GroupID'),
	 ...
	 * @return CoordinatorGroup the static model class
	 */
