...
/**
 * This is the model class for table "tbl_withdraw_reason".
 *
 * The followings are the available columns in table 'tbl_withdraw_reason':
 ...
 */
class WithdrawReason extends CActiveRecord
{
	/**
	 ...
	 * @return WithdrawReason the static model class
	 */
