...
/**
 * This is the model class for table "tbl_leavereason".
 *
 * The followings are the available columns in table 'tbl_leavereason':
 ...
 */
class Leavereason extends CActiveRecord
{
	/**
	...
	public function relations()
	{
		...
		return array(
			'leaves' => array(self::HAS_MANY, 'Leave', 'ReasonID'),
	 ...
	 * @return Leavereason the static model class
	 */
