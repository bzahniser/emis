...
class Reference extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('RefrenceName, Active, Created, CreatedBy, Updated, UpdatedBy', 'required'),
			array('Active, CreatedBy, UpdatedBy', 'numerical', 'integerOnly'=>true),
			array('RefrenceName', 'length', 'max'=>25),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('RefrenceID, RefrenceName, Active, Created, CreatedBy, Updated, UpdatedBy', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			...
			'students' => array(self::HAS_MANY, 'Student', 'RefrenceID'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('RefrenceName',$this->RefrenceName,true);
