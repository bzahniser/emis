...
/**
 * This is the model class for table "V_Cycle_Subject".
 *
 * The followings are the available columns in table 'V_Cycle_Subject':
 ...
 */
class VCycleSubject extends CActiveRecord
{
	/**
	 ...
	 * @return VCycleSubject the static model class
	 */
